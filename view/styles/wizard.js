		...
		function nextStep( step_n ){
			if( step_n > 0 ){
				document.getElementById('step'+(step_n-1)).style.display = 'none';
				document.getElementById('step'+step_n).style.display = '';
			}
		}
		
		function prevStep( step_n ){
			document.getElementById('step'+(step_n+1)).style.display = 'none';
			document.getElementById('step'+step_n).style.display = '';
		}
