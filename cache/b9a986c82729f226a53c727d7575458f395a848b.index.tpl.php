...
function content_5839f19e0614c0_06112249 (Smarty_Internal_Template $_smarty_tpl) {
?>
          ...
          <form class="navbar-form navbar-right" role="form" action="login.php"
            ...
            <?php echo '?>';?>
              <div class="alert alert-danger">
                <i class="glyphicon glyphicon-warning-sign"></i> &nbsp; <?php echo '<?php ';?>echo $error; <?php echo '?>';?>!
              </div>
            <?php echo '<?php
              ';?>}
            <?php echo '?>';?>-->
